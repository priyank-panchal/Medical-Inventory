                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Manage Invoice Reports</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                     ...
                     <div class="card-body">
                                ...
                                <?php
                                    if(isset($_POST['report']))
                                    {
                                        $d1=$_POST['d1'];   
                                        $d2=$_POST['d2'];
                                             $s1="select * from invoice_details where date_In between '$d1' and '$d2'";
                                       ...
                                       <td><?php echo $i;?></td>
                                      <td>
                                      <?php $qry2="select * from customer where c_id=$rq[1]"; 
                                      $fry=mysqli_query($con,$qry2)or die(mysqli_error($con));
                                        $f1=mysqli_fetch_array($fry);
                                               echo $f1[1];?>
                                             </td>
                                      <td><?php echo $rq['grand_total'];?></td>
                                    <td><?php echo $rq['date_In'];?></td>
                                        </tr>
                                              <?php 
                                              $i++;
