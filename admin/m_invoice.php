                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                              ...
                                              else
                                              {
                                                ...
                                                foreach($mtble as $s)
                                          {
                                            //select 8 from deel where inis=$s-inid $df=myfa
                                            $valqry="SELECT * FROM `delivery` WHERE In_id='$s->In_id' ";
                                            $fryval=mysqli_query($v,$valqry);
                                            $countvalue=mysqli_num_rows($fryval); 
                                                    ?>
                                                <tr>
