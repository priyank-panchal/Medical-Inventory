...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><img class="logo-img" src="assets/images/medicine.png" height="20%" width="20%" alt="logo"></a><span class="splash-description">Admin Panel</span></div>
            <div class="card-body">
                <form method="post">
